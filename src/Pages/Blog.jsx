        ...
        <div ref={ref} className="my-4 grid gap-3">
          <div className="bg-slate-300 p-2 rounded-lg">
            ...
            <p className="ps-4">
              ...
              textarea, select) whose value is controlled by React via its
              props. In other words, the value of a controlled component is
              always set by the parent component and changes are handled through
              callbacks. <br />
              <b>Uncontrolled Components:</b> <br />
              On the other hand, an uncontrolled component is a form element
              whose value is handled by the DOM itself. In other words, the
              value of an uncontrolled component is determined by the user input
              and not by React.
            </p>
          </div>
          <div className="bg-green-400 p-2 rounded-lg">
            ...
            <p className="ps-4">
              ...
              data types of props passed to a component. It ensures that the
              data is of the expected type and shape, catching bugs early in
          ...
          <div className="bg-gray-600 p-2 rounded-lg">
            ...
            <div className="ps-4 text-[#f0fdff]">
              ...
              <br />
              <p className="py-1">
                <b>Node.js</b> is a JavaScript runtime that allows developers to
              ...
              <span>
                ...
                applications. It provides a set of features and tools that make
                it easier to handle requests and responses, manage routes, and
                handle middleware.
              </span>
              <br />
              <br />
          ...
          <div className="bg-teal-400 p-2 rounded-lg">
            ...
            <p className="ps-4">
              ...
              and encapsulates logic and stateful behavior that can be shared
              across multiple components. Custom hooks promote code reuse,
              reduce code duplication, and make components more modular and
              easier to maintain.For that reason we would create a custom hook.
            </p>
          </div>
        </div>
      </div>
